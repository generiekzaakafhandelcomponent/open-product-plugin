...
This is a Open Product Plugin demonstrating an API call action. It fetches data from a time API endpoint.
...
```kotlin
dependencies {
    implementation("com.ritense.valtimoplugins:open-product:0.0.1")
}
```
...
{
  "dependencies": {
    "@valtimo-plugins/open-product": "0.0.1"
  }
}
```
...
} from '@valtimo-plugins/open-product';
